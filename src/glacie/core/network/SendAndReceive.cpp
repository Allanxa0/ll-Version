...
LL_AUTO_TYPE_INSTANCE_HOOK(
    ...
    ll::memory::SymbolView("?handle@ServerNetworkHandler@@UEAAXAEBVNetworkIdentifier@@AEBVRequestNetworkSettingsPacket@@@Z"),
    void,
    NetworkIdentifier const& a1,
    RequestNetworkSettingsPacket const& a2
) {
    if (SupportProtocolList.count(a2.mClientNetworkVersion)) {
        glacie::GlacieMod::getInstance().getSelf().getLogger().info("Client Connecting, Guid: {}, Protocol Version: {}", a1.mGuid.g, a2.mClientNetworkVersion);
        ...
        glacie::GlacieMod::getInstance().getSelf().getLogger().info("Client Disconnected, Guid: {}, Unsupported Protocol Version: {}", a1.mGuid.g, a2.mClientNetworkVersion);
    }
    origin(a1, a2);
}
...
LL_AUTO_TYPE_INSTANCE_HOOK(
    ...
    ll::memory::SymbolView("?sendToClients@LoopbackPacketSender@@UEAAXAEBV?$vector@UNetworkIdentifierWithSubId@@V?$allocator@UNetworkIdentifierWithSubId@@@std@@@std@@AEBVPacket@@@Z"),
    void,
...
LL_AUTO_TYPE_INSTANCE_HOOK(
    ...
    ll::memory::HookPriority::Normal,
    ServerNetworkHandler,
    ll::memory::SymbolView("?allowIncomingPacketId@ServerNetworkHandler@@UEAA_NAEBVNetworkIdentifier@@W4MinecraftPacketIds@@@Z"),
    bool,
    NetworkIdentifier const& a1,
...
LL_AUTO_TYPE_INSTANCE_HOOK(
    ...
    ll::memory::HookPriority::Normal,
    NetworkSystem,
    ll::memory::SymbolView("?send@NetworkSystem@@QEAAXAEBVNetworkIdentifier@@AEBVPacket@@W4SubClientId@@@Z"),
    void,
    NetworkIdentifier const& a1,
    Packet const& a2,
    SubClientId a3
...
LL_AUTO_TYPE_INSTANCE_HOOK(
    ...
    ll::memory::HookPriority::Normal,
    NetworkSystem,
    ll::memory::SymbolView("?_sortAndPacketizeEvents@NetworkSystem@@AEAA_NAEAVNetworkConnection@@V?$time_point@Usteady_clock@chrono@std@@V?$duration@_JU?$ratio@$00$0DLJKMKAA@@std@@@23@@chrono@std@@@Z"),
    bool,
...
LL_AUTO_TYPE_INSTANCE_HOOK(
    ...
    ll::memory::HookPriority::Normal,
    Packet,
    ll::memory::SymbolView("?read@Packet@@UEAA?AV?$Result@XVerror_code@std@@@Bedrock@@AEAVReadOnlyBinaryStream@@@Z"),
    Bedrock::Result<void>,
